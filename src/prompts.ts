...
export const PROMPTS: Prompt[] = [
  ...
  {
    id: "fresh-eyes-audit",
    title: "Fresh-eyes audit of how you work",
    group: "chief-of-staff",
    summary: "Asks the agent to look at everything it can reach and say where you are the bottleneck.",
    snippet:
      "I want a fresh-eyes audit of how my business runs with AI. Where I'm the bottleneck: every spot where the work stops until I step in. A scorecard, 1 to 10, for plan, build, run, track, improve and self-improve.",
    author: "Andrew Lane",
    url: "https://x.com/Andrew22Lane/status/2102490153012888001",
    source: "X",
  },
  {
